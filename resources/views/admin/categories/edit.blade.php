...
<style>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="max-w-2xl mx-auto">
            <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    @if($category->image_url)
                        <div class="mb-2">
                            <img src="{{ asset($category->image_url) }}" alt="{{ $category->name }}" class="h-20 w-20 object-cover rounded">
                        </div>
                    @endif
