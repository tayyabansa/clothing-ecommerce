            ...
            <nav class="bg-white border-b border-gray-100" x-data="{ open: false }">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <a href="{{ route('home') }}" class="text-3xl logo-text">
                                    ÉLÉGANCE
                                </a>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <a href="{{ route('home') }}" class="nav-link inline-flex items-center px-1 pt-1 border-b-2 {{ request()->routeIs('home') ? 'active' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none">
                                    {{ __('Home') }}
                                </a>
                ...
                <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <a href="{{ route('home') }}" class="nav-link block pl-3 pr-4 py-2 border-l-4 {{ request()->routeIs('home') ? 'active border-teal-400 text-teal-700 bg-teal-50' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300' }} text-base font-medium transition duration-150 ease-in-out focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300">
                            {{ __('Home') }}
                        </a>
