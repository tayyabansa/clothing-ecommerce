    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div class="text-center">
            ...
            <a href="{{ route('products.index') }}" 
                class="inline-block bg-white text-indigo-600 px-8 py-4 rounded-full font-semibold 
...
<div class="bg-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            @foreach(['Men', 'Women', 'Accessories', 'Footwear'] as $category)
...
<div class="bg-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gradient-to-r from-red-500 to-pink-500 rounded-2xl p-8 text-white">
            <div class="flex items-center justify-between mb-8">
                ...
                <div class="flash-sale-badge bg-white text-red-500 px-4 py-2 rounded-full font-bold">
                    Ends in: 24:00:00
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="product-card bg-white rounded-xl overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('products.show', $product) }}" 
                                class="bg-red-500 text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-red-600">
                                Shop Now
                            </a>
                        </div>
                    </div>
...
<div class="bg-gray-50 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="text-center">
                <div class="feature-icon w-16 h-16 mx-auto mb-4 bg-indigo-100 rounded-full flex items-center justify-center">
                    <svg class="w-8 h-8 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        ...
        <div class="max-w-3xl mx-auto text-center">
            ...
            <form class="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
                <input type="email" placeholder="Enter your email" 
                    class="flex-1 px-6 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                <button type="submit" 
